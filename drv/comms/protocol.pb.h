...
#define _ReplyId_MAX ReplyId_CONFIG
#define _ReplyId_ARRAYSIZE ((ReplyId)(ReplyId_CONFIG+1))
...
typedef struct _Config_FootPadSettings {
    bool has_filter_rc;
    float filter_rc;
    bool has_min_level_to_start;
    int32_t min_level_to_start;
    bool has_min_level_to_continue;
...
typedef struct _Stats {
    ...
    float motor_current;
    pb_callback_t pad_pressure;
    bool has_speed;
    float speed;
    bool has_distance_traveled;
    float distance_traveled;
    bool has_drive_angle;
    float drive_angle;
    bool has_stear_angle;
    float stear_angle;
...
typedef struct _Config {
    ...
    bool has_balance_pid;
    Config_PidConfig balance_pid;
    bool has_foot_pad;
    Config_FootPadSettings foot_pad;
    bool has_balance_expo;
    float balance_expo;
    bool has_balance_angle_scaling;
    float balance_angle_scaling;
    bool has_beep_rc;
    float beep_rc;
    bool has_beep_threshold;
...
#define Config_init_default                      {false, Config_Callibration_init_default, false, Config_PidConfig_init_default, false, Config_FootPadSettings_init_default, false, 0, false, 0, false, 0, false, 0}
#define Config_Callibration_init_default         {0, 0, 0}
#define Config_PidConfig_init_default            {175, 0.35, 0.05, 10000}
#define Config_FootPadSettings_init_default      {false, 0, false, 0, false, 0}
#define Stats_init_default                       {false, 0, false, 0, false, 0, {{NULL}, NULL}, false, 0, false, 0, false, 0, false, 0}
#define Config_init_zero                         {false, Config_Callibration_init_zero, false, Config_PidConfig_init_zero, false, Config_FootPadSettings_init_zero, false, 0, false, 0, false, 0, false, 0}
#define Config_Callibration_init_zero            {0, 0, 0}
#define Config_PidConfig_init_zero               {0, 0, 0, 0}
#define Config_FootPadSettings_init_zero         {false, 0, false, 0, false, 0}
#define Stats_init_zero                          {false, 0, false, 0, false, 0, {{NULL}, NULL}, false, 0, false, 0, false, 0, false, 0}
...
#define Stats_pad_pressure_tag                   4
...
#define Config_balance_expo_tag                  4
#define Config_balance_angle_scaling_tag         5
#define Config_beep_rc_tag                       6
#define Config_beep_threshold_tag                7
