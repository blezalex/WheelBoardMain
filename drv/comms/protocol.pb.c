...
const pb_field_t Config_Misc_fields[12] = {
    ...
    PB_FIELD( 15, FLOAT   , OPTIONAL, STATIC  , OTHER, Config_Misc, erpm_to_dist_const, speed_input_mixin, &Config_Misc_erpm_to_dist_const_default),
    PB_LAST_FIELD
};
