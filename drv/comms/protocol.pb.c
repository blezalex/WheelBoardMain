...
const float Config_PidConfig_i_default = 0.2;
...
const float Config_BalancingConfig_balance_angle_scaling_default = 12;
...
const float Config_BalancingConfig_balance_d_param_lpf_rc_default = 0.15;
...
const pb_field_t Config_BalancingConfig_fields[13] = {
...
const pb_field_t Stats_fields[11] = {
    ...
    PB_FIELD( 11, FLOAT   , OPTIONAL, STATIC  , OTHER, Stats, motor_duty, pad_pressure2, 0),
    PB_LAST_FIELD
};
