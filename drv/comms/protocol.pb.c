...
/* Generated by nanopb-0.3.9.2 at Wed May 01 22:12:02 2019. */
...
const float Config_PidConfig_p_default = 2200;
const float Config_PidConfig_d_default = 0.65;
const float Config_PidConfig_i_default = 0.9;
const float Config_PidConfig_max_i_default = 500;
const float Config_FootPadSettings_filter_rc_default = 0.03;
...
const int32_t Config_FootPadSettings_shutoff_delay_ms_default = 0;
const float Config_BalancingConfig_balance_expo_default = 1.4;
const float Config_BalancingConfig_balance_angle_scaling_default = 10;
...
const float Config_BalancingConfig_output_lpf_rc_default = 1;
const int32_t Config_BalancingConfig_balance_d_param_limiter_default = 300;
const float Config_BalancingConfig_balance_d_param_lpf_rc_default = 1;
const uint32_t Config_BalancingConfig_global_gyro_lpf_default = 2u;
const float Config_Misc_beep_rc_default = 0.05;
const float Config_Misc_beep_threshold_default = 0.75;
...
const pb_field_t Config_BalancingConfig_fields[11] = {
    ...
    PB_FIELD(  7, FLOAT   , REQUIRED, STATIC  , OTHER, Config_BalancingConfig, output_lpf_rc, max_update_limiter, &Config_BalancingConfig_output_lpf_rc_default),
    PB_FIELD(  8, INT32   , REQUIRED, STATIC  , OTHER, Config_BalancingConfig, balance_d_param_limiter, output_lpf_rc, &Config_BalancingConfig_balance_d_param_limiter_default),
    PB_FIELD(  9, FLOAT   , REQUIRED, STATIC  , OTHER, Config_BalancingConfig, balance_d_param_lpf_rc, balance_d_param_limiter, &Config_BalancingConfig_balance_d_param_lpf_rc_default),
    PB_FIELD( 10, UINT32  , REQUIRED, STATIC  , OTHER, Config_BalancingConfig, global_gyro_lpf, balance_d_param_lpf_rc, &Config_BalancingConfig_global_gyro_lpf_default),
    PB_LAST_FIELD
};

const pb_field_t Config_Misc_fields[3] = {
    PB_FIELD(  6, FLOAT   , REQUIRED, STATIC  , FIRST, Config_Misc, beep_rc, beep_rc, &Config_Misc_beep_rc_default),
    PB_FIELD(  7, FLOAT   , REQUIRED, STATIC  , OTHER, Config_Misc, beep_threshold, beep_rc, &Config_Misc_beep_threshold_default),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Config, callibration) < 65536 && pb_membersize(Config, balance_pid) < 65536 && pb_membersize(Config, foot_pad) < 65536 && pb_membersize(Config, balance_settings) < 65536 && pb_membersize(Config, misc) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Config_Config_Callibration_Config_PidConfig_Config_FootPadSettings_Config_BalancingConfig_Config_Misc_Stats)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Config, callibration) < 256 && pb_membersize(Config, balance_pid) < 256 && pb_membersize(Config, foot_pad) < 256 && pb_membersize(Config, balance_settings) < 256 && pb_membersize(Config, misc) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Config_Config_Callibration_Config_PidConfig_Config_FootPadSettings_Config_BalancingConfig_Config_Misc_Stats)
#endif
