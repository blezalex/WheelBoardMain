...
const float Config_BalancingConfig_balance_expo_default = 1;
const float Config_BalancingConfig_balance_angle_scaling_default = 1;
...
const pb_field_t Config_BalancingConfig_fields[3] = {
