...
const pb_field_t Config_fields[10] = {
    ...
    PB_FIELD(  9, MESSAGE , OPTIONAL, STATIC  , OTHER, Config, rate_pid, keep_roll, &Config_PidConfig_fields),
    PB_LAST_FIELD
};
...
const pb_field_t Config_Misc_fields[10] = {
    PB_FIELD(  6, FLOAT   , REQUIRED, STATIC  , FIRST, Config_Misc, throttle_rc, throttle_rc, &Config_Misc_throttle_rc_default),
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Config, callibration) < 65536 && pb_membersize(Config, balance_pid) < 65536 && pb_membersize(Config, foot_pad) < 65536 && pb_membersize(Config, balance_settings) < 65536 && pb_membersize(Config, misc) < 65536 && pb_membersize(Config, pushback) < 65536 && pb_membersize(Config, load_lift) < 65536 && pb_membersize(Config, keep_roll) < 65536 && pb_membersize(Config, rate_pid) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Config_Config_Callibration_Config_PidConfig_Config_FootPadSettings_Config_BalancingConfig_Config_PusbackSettings_Config_Misc_Config_LoadLift_Config_KeepRoll_Stats)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Config, callibration) < 256 && pb_membersize(Config, balance_pid) < 256 && pb_membersize(Config, foot_pad) < 256 && pb_membersize(Config, balance_settings) < 256 && pb_membersize(Config, misc) < 256 && pb_membersize(Config, pushback) < 256 && pb_membersize(Config, load_lift) < 256 && pb_membersize(Config, keep_roll) < 256 && pb_membersize(Config, rate_pid) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Config_Config_Callibration_Config_PidConfig_Config_FootPadSettings_Config_BalancingConfig_Config_PusbackSettings_Config_Misc_Config_LoadLift_Config_KeepRoll_Stats)
#endif
