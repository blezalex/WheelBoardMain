...
/* Generated by nanopb-0.3.9.2 at Fri Sep 27 21:57:00 2019. */
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Config, callibration) < 256 && pb_membersize(Config, balance_pid) < 256 && pb_membersize(Config, foot_pad) < 256 && pb_membersize(Config, balance_settings) < 256 && pb_membersize(Config, misc) < 256 && pb_membersize(Config, pushback) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Config_Config_Callibration_Config_PidConfig_Config_FootPadSettings_Config_BalancingConfig_Config_PusbackSettings_Config_Misc_Stats)
#endif
