...
/* Generated by nanopb-0.3.9.2 at Sat Oct 12 17:43:15 2019. */
...
const int32_t Config_PusbackSettings_min_speed_erpm_default = 1000;
const int32_t Config_PusbackSettings_push_angle_default = 5;
...
const float Config_FloatSettings_p_scaler_default = 1;
const float Config_FloatSettings_p_reconcile_rate_default = 0.001;
...
const pb_field_t Config_fields[8] = {
    ...
    PB_FIELD(  7, MESSAGE , OPTIONAL, STATIC  , OTHER, Config, floating, pushback, &Config_FloatSettings_fields),
    PB_LAST_FIELD
};
...
const pb_field_t Config_PusbackSettings_fields[5] = {
    ...
    PB_FIELD(  2, INT32   , REQUIRED, STATIC  , OTHER, Config_PusbackSettings, push_angle, min_speed_erpm, &Config_PusbackSettings_push_angle_default),
    PB_FIELD(  3, FLOAT   , REQUIRED, STATIC  , OTHER, Config_PusbackSettings, push_raise_speed_deg_sec, push_angle, &Config_PusbackSettings_push_raise_speed_deg_sec_default),
...
const pb_field_t Config_Misc_fields[11] = {
    ...
    PB_FIELD( 14, FLOAT   , OPTIONAL, STATIC  , OTHER, Config_Misc, speed_input_mixin, volt_rc, &Config_Misc_speed_input_mixin_default),
    PB_LAST_FIELD
};

const pb_field_t Config_FloatSettings_fields[3] = {
    PB_FIELD(  1, FLOAT   , REQUIRED, STATIC  , FIRST, Config_FloatSettings, p_scaler, p_scaler, &Config_FloatSettings_p_scaler_default),
    PB_FIELD(  2, FLOAT   , REQUIRED, STATIC  , OTHER, Config_FloatSettings, p_reconcile_rate, p_scaler, &Config_FloatSettings_p_reconcile_rate_default),
    PB_LAST_FIELD
};
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Config, callibration) < 256 && pb_membersize(Config, balance_pid) < 256 && pb_membersize(Config, foot_pad) < 256 && pb_membersize(Config, balance_settings) < 256 && pb_membersize(Config, misc) < 256 && pb_membersize(Config, pushback) < 256 && pb_membersize(Config, floating) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Config_Config_Callibration_Config_PidConfig_Config_FootPadSettings_Config_BalancingConfig_Config_PusbackSettings_Config_Misc_Config_FloatSettings_Stats)
#endif
